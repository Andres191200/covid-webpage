    ...
    return (
        <div className={`card-main-div card-${cardNumber}`}>
            ...
            <div className="info-container">
                <div className="progressdiv" data-percent={percentage}>
                    <svg className="progress" width="178" height="178" viewport="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
